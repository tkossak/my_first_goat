...
@click.option('--info', is_flag=True, help='Display info about configuration/database file')
...
def main(test, get, send, loot, search_server, search_channel, search_user, info, verbose):
    """
